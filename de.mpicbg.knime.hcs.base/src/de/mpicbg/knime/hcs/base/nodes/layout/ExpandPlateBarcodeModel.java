...
public class ExpandPlateBarcodeModel extends AbstractNodeModel {
	...
	protected ExpandPlateBarcodeModel() {
		...
		addModelSetting(ExpandPlateBarcodeModel.CFG_INSERT_COLUMN, createInsertColumnSM());
		addModelSetting(ExpandPlateBarcodeModel.CFG_INSERT_COLUMN_FIRST, createInsertFirstSM());
	}

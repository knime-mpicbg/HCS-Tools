...
public class RowColumnDialog extends JDialog implements ItemListener {
    ...
    /** Radio button for the automatic row-column configuration of the {@link de.mpicbg.tds.knime.heatmap.renderer.HeatTrellis} */
    private JRadioButton automaticRadioButton;
    /** Radio button for the manual (custom) row-column configuration of the {@link de.mpicbg.tds.knime.heatmap.renderer.HeatTrellis} */
